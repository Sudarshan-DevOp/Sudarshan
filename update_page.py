...
const Background3D = dynamic(() => import("@/components/Background3D"), {
  ssr: false,
  loading: () => <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'linear-gradient(135deg, #0a0a0f 0%, #1a1a2e 100%)', zIndex: 0 }} />,
});
...
export default function Home() {
  ...
  const filteredProjects = projectFilter === "All" ? projects : projects.filter((p: any) => p.category === projectFilter || p.tech.includes(projectFilter));
  ...
  useGSAP(() => {
    ...
    const sections = gsap.utils.toArray([".about-section", ".skills-section", ".experience-section", ".projects-section", ".contact-section"]);
    
    sections.forEach((section: any) => {
      gsap.fromTo(
        section.querySelectorAll(".section-title, .box-card, .timeline-item, .skills-category, .project-card, .contact-item"),
        { opacity: 0, y: 50 },
        {
          opacity: 1,
          y: 0,
      ...
      <div className="app-container">
        <header className="navbar">
          ...
          <div className="nav-actions">
            <button id="theme-toggle" className="icon-btn" onClick={toggleTheme}>
        ...
        <main>
          ...
          <section id="skills" className="skills-section">
            ...
            <div className="skills-container box-card">
              ...
              <div className="skills-category">
                <h3>AI / ML</h3>
                <div className="skills-grid">
                  <div className="skill-card"><i className="fas fa-brain"></i> CNN</div>
                  <div className="skill-card"><i className="fas fa-robot"></i> LLMs</div>
                  <div className="skill-card"><i className="fas fa-microchip"></i> LoRA / QLoRA</div>
                  <div className="skill-card"><i className="fas fa-network-wired"></i> Crew AI</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="experience" className="experience-section">
            <div className="section-title">
              <h2>My <span>Experience & Education</span></h2>
            </div>
                ...
                <div className="project-card" key={idx}>
                  <div className="project-content">
                    ...
                    <div className="project-links">
                      <a href={project.github} target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i> Source Code</a>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <section id="contact" className="contact-section">
            ...
            <div className="contact-container">
              ...
              <div className="contact-item">
                ...
                <div className="contact-info">
                  <h3>Website</h3>
                  <a href="https://sudarshanshrivastava.netlify.app" target="_blank" rel="noopener noreferrer">sudarshanshrivastava.netlify.app</a>
                </div>
              </div>
            </div>
          </section>
...
with open('/home/sudarshan/Downloads/sudarshan/src/app/page.tsx', 'w') as f:
    f.write(code)
